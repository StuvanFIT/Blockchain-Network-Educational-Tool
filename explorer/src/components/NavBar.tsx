    ...
    return (
        <nav className="relative sticky top-0 z-50 h-20 flex items-center justify-between p-2 bg-slate-800/95 backdrop-blur-sm border-b border-slate-700/50 shadow-2xl">
            ...
            <div className='hidden md:flex space-x-8 text-xl'>
                <a href='/concepts/Concepts' className='hover:text-cyan-400 transition-colors text-slate-300 font-bold relative group'>
                    Concepts
                    <span className='absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-400 group-hover:w-full transition-all duration-300'></span>
                </a>
                <a href='/resources/Resources' className='hover:text-cyan-400 transition-colors text-slate-300 font-bold relative group'>
                    Learning Resources
                    <span className='absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-400 group-hover:w-full transition-all duration-300'></span>
                </a>
            </div>
